...
<head>
  ...
  <meta name="keywords" content="onepage, resume, CV HTML template, personal Vcard, html resume, free resume template, free HTML template, free bootstrap template, personal portfolio, free html portfolio">
	...
	<title>최형택 포트폴리오</title>

  <!-- Web Fonts -->
  <link href='http://fonts.googleapis.com/css?family=Roboto:400,300,500,700' rel='stylesheet' type='text/css'>
	<!-- Bootstrap core CSS -->
	<link href="${pageContext.request.contextPath}/resources/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
	<!-- Font Awesome CSS -->
	<link href="${pageContext.request.contextPath}/resources/assets/css/font-awesome.min.css" rel="stylesheet" media="screen">
	<!-- Animate css -->
  ...
  <!-- Magnific css -->
	...
	<!-- Custom styles CSS -->
	<link href="${pageContext.request.contextPath}/resources/assets/css/style.css" rel="stylesheet" media="screen">
  <!-- Responsive CSS -->
  ...
  <link rel="shortcut icon" href="resources/assets/images/ico/favicon.png">
...
<body>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-push-8">
            <div class="biography">
              <div class="myphoto">
                <img src="resources/assets/images/myphoto.jpg" alt="">
              </div>
              <ul>
          ...
          <div class="col-md-8 col-md-pull-4">
            ...
            <div class="my-signature">
              <img src="resources/assets/images/sign.png" alt="">
            </div>
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "identety", "interface"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-1.jpg" alt="image"> 
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "identety", "web"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-2.jpg" alt="image"> 
                  <div class="portfolio-info">
                    <h3>Portfolio Title</h3>
                  </div><!-- /.portfolio-info -->
                </div><!-- /.portfolio -->
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "interface"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-3.jpg" alt="image"> 
                  <div class="portfolio-info">
                    <h3>Portfolio Title</h3>
                  </div><!-- /.portfolio-info -->
                </div><!-- /.portfolio -->
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "identety", "design"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-4.jpg" alt="image"> 
                  <div class="portfolio-info">
                    <h3>Portfolio Title</h3>
                  </div><!-- /.portfolio-info -->
                </div><!-- /.portfolio -->
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "identety", "design"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-5.jpg" alt="image"> 
                  <div class="portfolio-info">
                    <h3>Portfolio Title</h3>
                  </div><!-- /.portfolio-info -->
                </div><!-- /.portfolio -->
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "identety", "design"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-6.jpg" alt="image"> 
                  <div class="portfolio-info">
                    <h3>Portfolio Title</h3>
                  </div><!-- /.portfolio-info -->
                </div><!-- /.portfolio -->
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "identety", "web"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-7.jpg" alt="image"> 
                  <div class="portfolio-info">
                    <h3>Portfolio Title</h3>
                  </div><!-- /.portfolio-info -->
                </div><!-- /.portfolio -->
            ...
            <div class="portfolio-item col-xs-12 col-sm-4 col-md-3" data-groups='["all", "design"]'>
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <img src="resources/assets/images/works/portfolio-8.jpg" alt="image"> 
                  <div class="portfolio-info">
                    <h3>Portfolio Title</h3>
                  </div><!-- /.portfolio-info -->
                </div><!-- /.portfolio -->
        ...
        <div class="row">
            ...
            <article class="blog-post-wrapper">
              <div class="figure">    
                <div class="post-thumbnail">
                  <a href="#"><img src="resources/assets/images/blog/01.jpg" class="img-responsive " alt=""></a>
                </div>
          ...
          <div class="col-sm-4">
            <article class="blog-post-wrapper">
              <div class="figure">    
                <div class="post-thumbnail">
                  <a href="#"><img src="resources/assets/images/blog/02.jpg" class="img-responsive " alt=""></a>
                </div>
          ...
          <div class="col-sm-4">
            <article class="blog-post-wrapper">
              <div class="figure">    
                <div class="post-thumbnail">
                  <a href="#"><img src="resources/assets/images/blog/03.jpg" class="img-responsive " alt=""></a>
                </div>
	...
	<!-- Javascript files -->
	<script src="<c:url value="/resources/assets/js/jquery.js" />">
	<script src="<c:url value="/resources/assets/bootstrap/js/bootstrap.min.js" />">
	<script src="<c:url value="/resources/assets/js/jquery.stellar.min.js" />">
	<script src="<c:url value="/resources/assets/js/jquery.sticky.js" />">
	<script src="<c:url value="/resources/assets/js/smoothscroll.js" />">
	<script src="<c:url value="/resources/assets/js/wow.min.js" />">
	<script src="<c:url value="/resources/assets/js/jquery.countTo.js" />">
	<script src="<c:url value="/resources/assets/js/jquery.inview.min.js" />">
	<script src="<c:url value="/resources/assets/js/jquery.easypiechart.js" />">
	<script src="<c:url value="/resources/assets/js/jquery.shuffle.min.js" />">
	<script src="<c:url value="/resources/assets/js/jquery.magnific-popup.min.js" />">
	<script src="http://a.vimeocdn.com/js/froogaloop2.min.js"></script>
  <script src="<c:url value="/resources/assets/js/jquery.fitvids.js" />">
  <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&amp;sensor=false"></script>
  <script src="<c:url value="/resources/assets/js/scripts.js" />">
</body>
</html>
